package com.daniebeler.pfpixelix.domain.service.sharkey.model
...
fun SharkeyNotificationDto.toDomain(): com.daniebeler.pfpixelix.domain.model.Notification =
    com.daniebeler.pfpixelix.domain.model.Notification(
...
private fun String?.toNotificationType() = when (this) {
    "mention", "quote" -> com.daniebeler.pfpixelix.domain.model.NotificationType.MENTION
    "reply" -> com.daniebeler.pfpixelix.domain.model.NotificationType.NEW_COMMENT
    "renote" -> com.daniebeler.pfpixelix.domain.model.NotificationType.REBLOG
    "reaction" -> com.daniebeler.pfpixelix.domain.model.NotificationType.FAVOURITE
    "follow" -> com.daniebeler.pfpixelix.domain.model.NotificationType.FOLLOW
    "receiveFollowRequest" -> com.daniebeler.pfpixelix.domain.model.NotificationType.FOLLOW_REQUEST
    else -> com.daniebeler.pfpixelix.domain.model.NotificationType.UNDEFINED
}
