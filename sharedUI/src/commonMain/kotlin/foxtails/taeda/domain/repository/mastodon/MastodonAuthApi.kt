package foxtails.taeda.domain.repository.mastodon

import co.touchlab.kermit.Logger
import foxtails.taeda.domain.model.AuthData
import foxtails.taeda.domain.model.AuthTokenMastodon
                ...
                install(Logging) {
                    logger = object : io.ktor.client.plugins.logging.Logger {
                        override fun log(message: String) {
                            Logger.v(tag = "PLACEHOLDER HttpAuth") {
