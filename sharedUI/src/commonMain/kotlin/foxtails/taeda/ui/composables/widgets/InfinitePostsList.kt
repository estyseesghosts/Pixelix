...
import foxtails.taeda.ui.composables.profile.SwitchViewComposable
import foxtails.taeda.ui.composables.profile.ViewEnum
import foxtails.taeda.ui.composables.profile.postsWrapperComposable
import foxtails.taeda.ui.composables.states.EmptyState
import foxtails.taeda.ui.composables.states.EmptyStateComposableWithoutRefresh
    ...
    CustomPullToRefreshBox(
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            if (error.isEmpty() || items.isNotEmpty() || before != null || isLoading) {
                ...
                if (isLoading) {
                    LoadingComposable()
                } else if (items.isEmpty() && error.isEmpty()) {
                    EmptyStateComposableWithoutRefresh(
                        emptyMessage
                    )
